...
function NewNewsContent() {
  ...
  const handleSave = async (publishNow: boolean = false) => {
    ...
    try {
      ...
      alert(publishNow ? t('admin.alert.published') : t('admin.alert.saved'))
    ...
    <div className="min-h-screen bg-gray-50" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900">{t('admin.news.newPost')}</h2>
            </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <h3 className="text-sm font-medium text-blue-800 mb-2">{t('admin.news.tips')}</h3>
          <ul className="text-sm text-blue-700 list-disc list-inside space-y-1">
            <li>{t('admin.news.tip1')}</li>
            <li>{t('admin.news.tip2')}</li>
            <li>{t('admin.news.tip3')}</li>
            <li><strong>{t('admin.news.tip4').split(':')[0]}:</strong>{t('admin.news.tip4').split(':')[1]}</li>
          </ul>
        </div>
      </main>
    </div>
